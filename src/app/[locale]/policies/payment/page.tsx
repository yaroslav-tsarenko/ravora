...
export const metadata = { title: "Payment Policy — VoltMarket" };
...
export default function PaymentPolicyPage() {
  return (
    <PolicyLayout title="Payment Policy" lastUpdated="29 May 2026">
      ...
      <p>
        1.2 VoltMarket sells electrical products, electrical materials, wiring accessories, lighting-related
      ...
      <p>
        2.5 VoltMarket does not control exchange rates, bank conversion fees, card issuer charges, or foreign
        transaction fees.
      </p>
      ...
      <p>
        3.4 Price changes will not affect orders already accepted by VoltMarket, except where there has been
      ...
      <p>4.1 VoltMarket accepts secure card payments using:</p>
      <ul>
        <li>Visa</li>
        <li>Mastercard</li>
      </ul>
      ...
      <p>
        5.3 VoltMarket does not guarantee that your payment will be accepted. Payment approval depends on
      ...
      <p>6.1 VoltMarket takes payment security seriously.</p>
      <p>
        6.2 Card payments are handled through secure third-party payment providers. VoltMarket does not store
      ...
      <p>
        8.2 VoltMarket is not responsible for payment failures caused by your bank, card issuer, payment
      ...
      <p>
        9.1 To protect customers, VoltMarket, payment providers, and card networks, transactions may be
      ...
      <p>
        10.3 Where applicable, VoltMarket may issue order confirmations, payment confirmations, receipts, VAT
      ...
      <p>12.1 VoltMarket dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        ...
        in the product price, delivery price, or payment collected by VoltMarket.
      </p>
      <p>
      ...
      <p>
        12.5 VoltMarket does not control customs authorities, customs delays, import tax assessments, courier
      ...
      <p>
        ...
        is required by law or approved by VoltMarket, the related Additional Warranty charge may also be
        refunded.
      </p>
      ...
      <p>
        ...
        are not controlled by VoltMarket and are not refundable by VoltMarket.
      </p>
      <p>
      ...
      <p>
        17.2 VoltMarket does not offer credit terms, open account purchasing, or deferred payment to Business
