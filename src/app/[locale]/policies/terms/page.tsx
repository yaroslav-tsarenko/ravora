...
export const metadata = { title: "Terms and Conditions — VoltMarket" };
  ...
  return (
    <PolicyLayout title="Terms and Conditions" lastUpdated="29 May 2026">
      <p>
        ...
        www.voltmarket.store and any related pages, services, orders, purchases, communications, and
        transactions operated under the VoltMarket brand.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In these Terms, &ldquo;VoltMarket&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or &ldquo;our&rdquo; means AVONTRA LTD.
      ...
      <p>
        ...
        account, submitting an order, or purchasing goods from VoltMarket, you agree to be bound by these
        Terms.
      </p>

      <h2>1. Scope of These Terms</h2>
      <p>1.1 These Terms apply to all use of the Website and all purchases of goods made through VoltMarket.</p>
      <p>
        1.2 VoltMarket sells physical electrical products, electrical materials, wiring accessories,
      ...
      <p>
        2.4 You must not use the Website or purchase goods from VoltMarket for any unlawful, unsafe,
        fraudulent, or unauthorised purpose.
      </p>

      <h2>3. Consumer and Business Customers</h2>
      <p>3.1 VoltMarket sells to both consumers and business customers.</p>
      <p>
      ...
      <p>
        5.4 VoltMarket does not provide electrical engineering, installation, compliance, inspection,
      ...
      <p>
        ...
        VoltMarket is general information only and must not be treated as a substitute for professional
      ...
      <p>
        7.3 A contract between you and VoltMarket is formed only when we accept your order, process it for
      ...
      <p>
        ...
        differences are the responsibility of the customer and are not controlled by VoltMarket.
      </p>
      ...
      <p>
        9.3 Payments are processed by secure third-party payment providers. VoltMarket does not store your
      ...
      <p>
        10.1 From time to time, VoltMarket may offer discounts, promotional codes, special prices, free
      ...
      <p>11.1 VoltMarket dispatches orders from the United Kingdom.</p>
      <p>
      ...
      <p>
        12.3 VoltMarket has no control over customs processing times, customs decisions, import restrictions,
      ...
      <p>
        ...
        failure to comply with local requirements, VoltMarket will not be responsible for the resulting loss,
      ...
      <p>
        14.4 To exercise your cancellation right, you must inform us clearly by email at info@voltmarket.store
      ...
      <p>
        ...
        commercial warranty, additional warranty, or return policy offered by VoltMarket.
      </p>
      <p>
      ...
      <p>18.1 VoltMarket may offer paid additional warranty options for selected products.</p>
      ...
      <p>
        18.9 To make an Additional Warranty claim, you must contact us at info@voltmarket.store with your order
      ...
      <p>
        20.1 Products sold by VoltMarket may be designed for specific markets, standards, voltage systems,
      ...
      <p>
        20.3 We do not guarantee that products purchased from VoltMarket will meet every local building code,
      ...
      <p>
        ...
        descriptions, photographs, videos, design elements, and other materials, belongs to VoltMarket,
      ...
      <p>25.3 Subject to sections 25.1 and 25.2, VoltMarket will not be liable for:</p>
      <ul>
