...
export const metadata = { title: "Returns, Refunds and Cancellation Policy — Ravora" };
  ...
  return (
    <PolicyLayout title="Returns, Refunds and Cancellation Policy" lastUpdated="29 May 2026">
      <p>
        ...
        purchases made through www.ravora.co.uk.
      </p>
      ...
      <p>
        3.2 To request cancellation, contact us as soon as possible at info@ravora.co.uk and include your
        order number.
      </p>
      <p>
      ...
      <p>
        4.4 To exercise your cancellation right, you must clearly notify us by email at info@ravora.co.uk
      ...
      <p>
        9.2 For faulty, damaged, or incorrect goods, Ravora will cover reasonable return shipping costs
      ...
      <p>10.1 To start a return, contact us at info@ravora.co.uk.</p>
      ...
      <p>
        13.5 If customs or courier charges are incurred by Ravora because of an international return,
      ...
      <p>
        14.2 Ravora is not responsible for delays, failed deliveries, lost parcels, return charges, or
      ...
      <p>
        16.2 Any non-faulty return accepted from a Business Customer is at Ravora&rsquo;s discretion.
      </p>
      ...
      <p>
        ...
        credit, or other remedy agreed by Ravora.
      </p>
