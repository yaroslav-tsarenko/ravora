...
export const metadata = { title: "Privacy Policy — Ravora" };

export default function PrivacyPolicyPage() {
  return (
    <PolicyLayout title="Privacy Policy" lastUpdated="29 May 2026">
      <p>
        This Privacy Policy explains how JAYHALE LIMITED, trading as Ravora, collects, uses, stores, shares,
        and protects personal data when you visit www.ravora.co.uk, create an account, place an order,
        contact us, use our services, or otherwise interact with us.
      </p>
      <p>The Website is operated by:</p>
      <ContactBlock />
      <p>
        In this Privacy Policy, &ldquo;Ravora&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo; or
        &ldquo;our&rdquo; means JAYHALE LIMITED. &ldquo;Customer&rdquo;, &ldquo;you&rdquo; or
      ...
      <p>
        ...
        Regulation, JAYHALE LIMITED is the data controller of your personal data.
      </p>
      ...
      <p>3.1 The personal data we collect depends on how you interact with Ravora.</p>
      ...
      <p>
        ...
        the relevant email or contacting us at info@ravora.co.uk.
      </p>
      <p>
      ...
      <p>
        11.1 Because Ravora sells internationally and uses third-party service providers, your personal
      ...
      <p>14.3 To exercise your rights, please contact us at info@ravora.co.uk.</p>
      ...
      <p>
        ...
        info@ravora.co.uk so we can try to resolve the matter.
      </p>
      <p>
      ...
      <p>
        ...
        info@ravora.co.uk and we will take appropriate steps to review and delete the information where
        required.
      </p>
