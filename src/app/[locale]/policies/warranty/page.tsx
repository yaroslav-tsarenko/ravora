...
export const metadata = { title: "Warranty Policy — VoltMarket" };
  ...
  return (
    <PolicyLayout title="Warranty Policy" lastUpdated="29 May 2026">
      <p>
        ...
        paid Additional Warranty options apply to products purchased through www.voltmarket.store.
      </p>
      ...
      <p>5.2 Manufacturer warranty terms are set by the manufacturer, not by VoltMarket.</p>
      <p>
      ...
      <p>
        5.5 VoltMarket may assist with manufacturer warranty claims where reasonable, but we do not control
      ...
      <p>6.1 VoltMarket may offer paid Additional Warranty options for selected products.</p>
      ...
      <p>11.1 To make a warranty claim, contact us at info@voltmarket.store.</p>
      ...
      <p>
        12.1 Warranty claims may require inspection by VoltMarket, the manufacturer, supplier, service
      ...
      <p>
        ...
        may be covered by VoltMarket where required by law or approved by us.
      </p>
      <p>
      ...
      <p>
        17.4 To the fullest extent permitted by law, VoltMarket will not be liable to Business Customers for
