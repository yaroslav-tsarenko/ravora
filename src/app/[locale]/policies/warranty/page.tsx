...
export const metadata = { title: "Warranty Policy — netim.com" };
...
export default function WarrantyPolicyPage() {
  return (
    <PolicyLayout title="Warranty Policy" lastUpdated="29 May 2026">
      ...
      <p>5.2 Manufacturer warranty terms are set by the manufacturer, not by netim.com.</p>
      <p>
      ...
      <p>
        5.5 netim.com may assist with manufacturer warranty claims where reasonable, but we do not control
      ...
      <p>6.1 netim.com may offer paid Additional Warranty options for selected products.</p>
      ...
      <p>
        12.1 Warranty claims may require inspection by netim.com, the manufacturer, supplier, service
      ...
      <p>
        ...
        may be covered by netim.com where required by law or approved by us.
      </p>
      <p>
      ...
      <p>
        17.4 To the fullest extent permitted by law, netim.com will not be liable to Business Customers for
